...
Date: June 21, 2020
Purpose: Script used to mask out false postive pixels in the YFC dataset by leveraging the CDL datasets. 
...
def run(data):
	###Description: Main function to create tiles in parallel
